...
const EditItem = () => {
  ...
  const [fontendImage, setFontendImage] = useState("");
  ...
  useEffect(() => {
    ...
    setFontendImage(currentItem?.image || "");
  }, [currentItem]);

  return (
    <div
      className="flex justify-center flex-col items-center p-6 bg-gradient-to-br fron-orange-50 relative
  to-white min-h-screen"
    >
      <div className="absolute top-[20px] left-[20px] x-[10] mb-[10px]">
        <IoIosArrowRoundBack
          size={35}
      ...
      <div className="max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100">
        <div className="flex flex-col items-center mb-6">
          ...
          <div className="tex-3xl font-extrabold text-gray-900">Edit Food</div>
        </div>
