...
const Nav = () => {
  ...
  return (
    <div className="w-full h-[80px] flex items-center justify-center fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible">
      ...
      <div className="w-full max-w-6xl px-4 flex items-center justify-between gap-[30px]">
        ...
        <div className="flex items-center gap-4">
          ...
          {userData.role == "owner" ? (
            ...
            bg-[#ff4d2d]/10 text-[#ff4d2d] font-medium"
              >
                ...
                <span>My Orders</span>
                <span
                  className="absolute -right-2 -top-2 text-xs font-bold text-white bg-[#ff4d3d] rounded-full 
              px-[6px] py-[1px]"
                >
                  0
                </span>
          ...
          <div
            className="w-[40px] h-[40px] rounded-full flex cursor-pointer items-center justify-center bg-[#ff4d2d] text-white
      text-[18px] shadow-xl font-semibold cursor5-pointer"
          ...
          {showInfo && (
            <div
              className="fixed top-[80px] right-[10px] md:right-[5%] lg:right-[5%] xl:right-[15%] w-[180px] bg-white
