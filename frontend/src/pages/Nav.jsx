...
const Nav = () => {
  ...
  return (
    ...
    >
      {showSearch && (
        <div className="w-[90%] h-[70px]  bg-white shadow-xl rounded-lg flex items-center gap-[20px] flex fixed top-[80px] left-[5%] ">
          <div className="flex items-center w-[30%] overflow-hidden gap-[10px] px-[10px] border-r-[2px] border-gray-400">
            <FaLocationDot size={25} className="text-[#ff4d3d]" />
            <div className="w-[80%] truncate text-gray-600">Lahore</div>
          </div>
